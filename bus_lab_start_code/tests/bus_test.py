...
class TestBus(unittest.TestCase):
    ...
    def test_can_pick_up_same_destination_passenger_from_bus_stop(self):
        person_3 = Person("Guido van Rossum", 64, "Waverly Station")
        person_4 = Person("Carol Willing", 50, "Waverly Station")
        person_5 = Person("Carol Willing", 50, "Ocean Terminal")
        bus_stop_1 = BusStop("Waverly Station") 
        bus_stop_1.add_to_queue(person_3)
        bus_stop_1.add_to_queue(person_4)
        bus_stop_1.add_to_queue(person_5)
        self.bus.pick_up_from_stop(bus_stop_1)
        self.assertEqual(2,self.bus.passenger_count())       
